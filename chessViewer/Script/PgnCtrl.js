var pieceImg = [{ RB:"RB.gif",RW:"RW.gif",NB :"NB.gif",NW :"NW.gif",BB :"BB.gif",BW :"BW.gif",
				  QB :"QB.gif",QW :"QW.gif",KB :"KB.gif",KW :"KW.gif",PB :"PB.gif",PW:"PW.gif"},
				{ RB:"_R.png",RW:"R.png",NB :"_N.png",NW :"N.png",BB :"_B.png",BW :"B.png",
				  QB :"_Q.png",QW :"Q.png",KB :"_K.png",KW :"K.png",PB :"_P.png",PW:"P.png"},
				{ RB:"_R1.png",RW:"R1.png",NB :"_N1.png",NW :"N1.png",BB :"_B1.png",BW :"B1.png",
				  QB :"_Q1.png",QW :"Q1.png",KB :"_K1.png",KW :"K1.png",PB :"_P1.png",PW:"P1.png"},
				{ RB:"_R2.png",RW:"R2.png",NB :"_N2.png",NW :"N2.png",BB :"_B2.png",BW :"B2.png",
				  QB :"_Q2.png",QW :"Q2.png",KB :"_K2.png",KW :"K2.png",PB :"_P2.png",PW:"P2.png"},
				];
var selectedSet = 1;
...
var PgnCtrl =
{
	...
	SetBoard: function ()
	{
		//var
			mainDiv = Append("div", document.body, "id=mainDiv;",
				"width:542px;height:378px;margin:0px;margin-left:4px;border:solid 1px #ccc;overflow: auto;"),
		...
		for (var i = 0; i < 8; i++){
			Append("a",mainDiv,"innerText="+"abcdefgh".substring(i,i+1),"position:relative;left:"+(14+i).toString()+"pt;margin:0pt 14pt 0pt 14pt;");	
		}
		for (var i = 0; i < 8; i++){
			Append("a",mainDiv,"innerText="+(8-i).toString(),"position:absolute;left:12pt;margin:"+(24+i*33).toString()+"pt 2pt 14pt 2pt;");
		}

		this.boardDiv = Append("div", mainDiv, "id=board;", 
			"width:352px;height:352px;border:solid 1px #797979;position:relative;top:2px;left:17px;");
		for (var i = 0; i < 64; i++)
		{
			var
				x = i % 8,
	...
	SetButtons: function ()
	{
		...
		this.AddSelect(ctrlDiv,"selectSet", "border-radius:8px;width:86px;height:26px;color:blue",function(){
			selectedSet = document.getElementById("selectSet").selectedIndex;
			me.SetPieces();
			me.ShowCaptures();
		});
	},

	AddSelect: function(div, id, style, action){
	...
	AddButton: function (div, val, action){
		var dx = (val == "First" ? "20px;" : val == "Info" ? "40px;" : "4px;"),
			o = Append("input", div, "type=button;value=" + val, 
				"background-color:#fdfdfd;border:solid 2px #aaa;border-radius:8px;padding:4px;margin:6px;margin-left:" + dx+";");
		o.onclick = action;
		o.onmouseover=function(){
			o.style.backgroundColor='#5d5d5d';
			o.style.color = '#ffffff';
		}
		o.onmouseout=function(){
			o.style.backgroundColor='#fdfdfd';
			o.style.color = '#222222';
		}
	},
	...
	GetImg: function (o)
	{
		o = o.substr(0, 1);
		var s =
			o == 'r' ? pieceImg[selectedSet].RB :
			o == 'R' ? pieceImg[selectedSet].RW :
			o == 'n' ? pieceImg[selectedSet].NB :
			o == 'N' ? pieceImg[selectedSet].NW :
			o == 'b' ? pieceImg[selectedSet].BB :
			o == 'B' ? pieceImg[selectedSet].BW :
			o == 'q' ? pieceImg[selectedSet].QB :
			o == 'Q' ? pieceImg[selectedSet].QW :
			o == 'k' ? pieceImg[selectedSet].KB :
			o == 'K' ? pieceImg[selectedSet].KW :
			o == 'p' ? pieceImg[selectedSet].PB :
			o == 'P' ? pieceImg[selectedSet].PW : "";
		return "Images/" + s + ";";// + ".gif;"
	},
};